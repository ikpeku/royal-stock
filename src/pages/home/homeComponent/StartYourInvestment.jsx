        ...
        <section className="bg-[#D9D9D9]">
            <div className="max-w-screen-2xl px-4 sm:px-6 lg:px-8 mx-auto py-16">
                <div className="grid grid-cols-1 gap-8 lg:gap-16 lg:grid-cols-2">
                    ...
                    <div className="relative lg:order-first flex gap-6">
                        <div>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-[#231955]">It is time to make your money work for you</h2>
                ...
                <div className="mt-32">
                    ...
                    <p className="text-center text-xl md:text-[48px] text-[#918CAA] font-thin mb-32">A Simple Process</p>
                    ...
                    <h4 className="sr-only">Steps</h4>
                        ...
                        >
                        <ol
                            className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-y-10 flex justify-between text-sm font-medium"
                        >
                ...
                <div className="flex justify-end">
                    <Link to="/signup" className="mt-20 inline-block w-full px-12 py-3 text-lg font-bold text-white rounded-[50px] shadow bg-[#231955] sm:w-auto focus:outline-none focus:ring-0 hover:invert-[.10]">
                        <button>
                            Create account
                        </button>
                    </Link>
