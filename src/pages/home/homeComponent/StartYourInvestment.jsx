...
const StartYourInvestment = () => {
  ...
  return (
    <section className="bg-[#D9D9D9]">
      <div className="max-w-screen-3xl px-4 sm:px-6 lg:px-8 mx-auto py-8 md:py-16">
        <div className="grid grid-cols-1 gap-8 lg:gap-8 lg:grid-cols-2">
          <div className="lg:order-first md:flex gap-12">
            <div className="ml-auto">
              <img src={StartYourInvestment1} alt="Money Icon" className="" />
              <p className="mt-4 text-[#231955] font-bold text-lg">
                Start your investment today
              </p>
            </div>
            <div>
              <img
                src={StartYourInvestment2}
                alt="Staff shaking hands"
                className=""
              />
              <p className="mt-4 text-[#231955] font-bold text-lg">
                We are your partner
          ...
          <div className="md:w-2/4 mx-auto">
            <h2 className="text-center md:text-start text-3xl font-bold text-[#231955]">
              It is time to make your money work for you
            </h2>

            <p className="mt-2 text-[#918CAA] italic">
              Whether you are looking to grow, preserve or pass on your wealth,
              we help our clients to achieve their financial ambitions by
              building lasting relationships, adopting a holistic approach to
              financial planning and providing whole of market advice
            </p>
          </div>
        </div>

        <div className="mt-8 ">
          <h2 className="text-[#231955] font-bold text-2xl text-center">
            HOW IT WORKS
          </h2>{" "}
          <br />
          <p className="text-center text-xl md:text-[48px] text-[#918CAA] font-thin mb-16">
            A Simple Process
          </p>
          <h4 className="sr-only">Steps</h4>
          <div className="relative after:inset-x-0 after:h-0.5 after:absolute after:top-1/2 after:-translate-y-1/2 after:block after:rounded-lg after:bg-white">
            <ol className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-y-10 md:flex justify-between text-sm font-medium">
              <li className="flex flex-col items-center md:items-start bg-[#D9D9D9]">
                <svg
                  className="md:ml-8 mb-6"
                  width="50"
                  height="50"
                  viewBox="0 0 50 50"
                  fill="none"
                ...
                >
                  <path
                    d="M0 16.2125C0 7.31563 11.1 0 25 0C38.9 0 50 7.31875 50 16.2125V33.7906C50 42.6812 38.9 50 25 50C11.1 50 0 42.6813 0 33.7875V16.2156V16.2125ZM22.5 3.22813C12.705 4.02812 5 9.48438 5 16.2125V17.1875H22.5V3.22813ZM27.5 3.22813V17.1875H45V16.2094C45 9.48438 37.295 4.02812 27.5 3.22813ZM45 20.3125H5V33.7906C5 41.0781 14.05 46.875 25 46.875C35.95 46.875 45 41.0781 45 33.7875V20.3125Z"
                    fill="#1F4690"
                  />
                </svg>

                <span className="text-[#231955] text-xl font-bold">
                  {" "}
                  Create account{" "}
                </span>
              </li>
              ...
              <li className="flex flex-col items-center bg-[#D9D9D9]">
                ...
                >
                  <path
                    d="M25 0L13.6364 8.69565H36.3636L25 0ZM7.95455 2.17391L0 12.2957V50H50V12.2957L42.0455 2.17391H30.6818L36.3636 6.52174H39.7727L43.1818 10.8696H6.81818L10.2273 6.52174H13.6364L19.3182 2.17391H7.95455ZM4.54545 15.2174H45.4545V45.6522H4.54545V15.2174ZM17.7568 19.5652C16.5045 19.6739 15.5795 20.7457 15.6955 21.9435C15.8114 23.1391 16.9295 24.0239 18.1818 23.913H31.8182C32.6364 23.9217 33.3977 23.513 33.8159 22.8348C34.0165 22.5015 34.1221 22.1237 34.1221 21.7391C34.1221 21.3546 34.0165 20.9767 33.8159 20.6435C33.3977 19.9652 32.6341 19.5565 31.8182 19.5652H17.7545H17.7568Z"
                    fill="#1F4690"
                  />
                </svg>
        ...
        <div className="flex justify-end">
          {!user && <button
            ...
            className="mt-10 inline-block w-full px-12 py-4 text-lg font-bold text-white text-center rounded-[50px] shadow bg-[#231955] sm:w-auto focus:outline-none focus:ring-0 hover:invert-[.10]"
          >
            Create account
          </button>}
