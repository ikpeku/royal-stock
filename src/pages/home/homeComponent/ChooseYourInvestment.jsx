    ...
    return (
        <section className="">
            <div className="py-8 px-4 mx-auto max-w-screen-2xl lg:py-16 lg:px-6">
                ...
                <div className="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-20 space-y-10">

                    <div
                        className="border-[4px] border-[#483F71] w-full flex flex-col p-6 mx-auto text-center text-[#231955] rounded-[20px] xl:p-8">
                        ...
                        <ul role="list" className="mb-8 space-y-4 text-left mt-16 font-bold text-lg">
                            <li className="text-center space-x-3">
                                Mini Invest: $100
                            </li>
                            <li className="h-px bg-[#231955] w-[50%] mx-auto"></li>
                            <li className="text-center space-x-3 text-center">
                                Max Invest: $1,000
                            </li>
